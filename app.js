...
/*$(function() {
  ...
  var firstarticleItem;
	...
	firstArticleItem = $('.article-item').find('img').attr('src', 'http://lorempixel.com/350/150/animals/');
})*/
...
function someFunction() {
	...
	firstArticleItem = $('.article-item').find('img').attr('src', 'http://placekitten.com/350/150');
}
$(someFunction)
